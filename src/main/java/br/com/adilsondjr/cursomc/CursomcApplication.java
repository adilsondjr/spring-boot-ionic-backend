package br.com.adilsondjr.cursomc;
...
import br.com.adilsondjr.cursomc.repositories.CidadeRepository;
...
import br.com.adilsondjr.cursomc.repositories.EstadoRepository;
import br.com.adilsondjr.cursomc.repositories.ItemPedidoRepository;
import br.com.adilsondjr.cursomc.repositories.PagamentoRepository;
import br.com.adilsondjr.cursomc.repositories.PedidoRepository;
import br.com.adilsondjr.cursomc.repositories.ProdutoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat1 = new Categoria(null, "Cama mesa e banho");
		...
		Categoria cat7 = new Categoria(null, "Utencilios e Acessórios");
		Categoria cat8 = new Categoria(null, "Higiene");
		Categoria cat9 = new Categoria(null, "Bebidas");
		Categoria cat10 = new Categoria(null, "Enxoval");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "11800611342", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("34714225", "34717015"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "37590000", cli1, c1);
		Endereco e2 = new Endereco(null, "Av Matos", "105", "Sala 80", "Centro", "37580000", cli1, c2);
			
		cli1.getEnderecos().addAll(Arrays.asList(e1, e2));
		
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm");
		Pedido ped1 = new Pedido(null, sdf.parse("30/09/2017 22:32"), cli1, e1);
